...
- **Last session:** 2026-07-16 — **Features #11 + #22 shipped** (`0e44aff`). #11 dashboard "Recent activity" feed (last 8 by `updated_at`, relative time, linked); #22 "Export CSV" of the filtered experiments table (hand-rolled, no new dep). Remaining before S6: P3 #20 autocomplete, #21 group summary, #23 Ask streaming, #24 edit history.
